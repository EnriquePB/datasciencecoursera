...
#read csv file and define columns as character variables
#outcome <- read.csv("outcome-of-care-measures.csv", colClasses = "character")

#Create histogram of 30 day death rates from heart attack (column 11 in the outcome dataset)

#deathrates[,11] <- as.numeric(outcome[,11])
#hist(deathrates[,11])
